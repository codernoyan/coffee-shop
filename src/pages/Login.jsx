    ...
    <section>
      <div className="container flex flex-col items-center justify-center min-h-screen px-6 mx-auto">
        <form onSubmit={handleSubmit(handleLogin)} className="w-full max-w-md">
          ...
          <div className="mt-6">
            <button type="submit" className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-slate-700 rounded-md hover:bg-slate-800 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
              Login
            </button>
        ...
        <div>
          ...
          <div className="mt-6 text-center ">
            ...
            <Link to="/register" className="text-sm underline text-slate-600 hover:underline dark:text-slate-600 font-medium">
              Register
            </Link>
          </div>
        </div>
